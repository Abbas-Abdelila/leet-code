...
class Codec:
 ...
 # A hacky approach is just return the input for both the decoder and encoder since you call the encode first and get the put it in decoder you will get your desired output withoit doing any thing
